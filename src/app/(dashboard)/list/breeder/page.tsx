...
const BreederListPage = async ({
  ...
  const query: Prisma.BreederWhereInput = {};
  ...
  const [data, count] = await prisma.$transaction([
    ...
    prisma.breeder.count({ where: query }),
  ]);
...
export default BreederListPage;
