  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-md h-80 relative">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
        <h1 className="text-3xl font-bold dark:text-gray-200">9.2</h1>
        <p className="text-xs text-gray-300 dark:text-gray-400">
          of 10 max GGS
        </p>
      </div>
      <h2 className="font-medium absolute bottom-16 left-0 right-0 m-auto text-center dark:text-gray-200">
