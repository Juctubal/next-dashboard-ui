  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow">
      ...
      >
        ...
        {/* Add information about brooding target */}
        {filters.targetType === "brooding" && (
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-blue-800">
                    Brooding & Vaccination Program
                  </h3>
                  <div className="mt-2 text-sm text-blue-700">
                    <p>
                      This program targets chicks under 8 weeks old and focuses
                      on:
                    </p>
                    <ul className="list-disc list-inside mt-1 space-y-1">
                      <li>
                        Essential early vaccinations (Newcastle Disease B1B1)
                      </li>
                      <li>Proper deworming schedule starting at 3-4 weeks</li>
                      <li>Critical environmental and nutritional management</li>
                      <li>
                        Health monitoring during vulnerable development stages
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        {recommendations.map((rec, index) => (
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
              ...
              {/* Show additional info for brooding */}
              {filters.targetType === "brooding" && (
                <>
                  <div>
      ...
      {recommendations.length === 0 && !loading && (
        <div className="text-center py-8 text-gray-500">
          {filters.targetType === "derby" && filters.eventId ? (
            ...
            <div>
              <p>
                No chicks under 8 weeks old found for brooding recommendations.
              </p>
              <p className="text-sm mt-2">
                Brooding programs are specifically designed for recently hatched
                chicks. Check if you have any chicks that need brooding care and
